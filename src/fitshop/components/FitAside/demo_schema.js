...
export const parseSchema = (str) => {
    console.log(str, '0-0-0-0-')
    let startTag = '{% schema %}'
    let endTag = '{% endschema %}'
    let startPos = string.indexOf(startTag) + startTag.length
    let endPos = string.indexOf(endTag)
